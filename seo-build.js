...
const UI = {
  ...
  uk:{ catalog:'Каталог ніш', pricing:'Тарифи', how:'Як це працює', cabinet:'Кабінет ↗',
       ...
       caps:['Працює в Telegram, WhatsApp, Instagram і у віджеті на сайті — текст і голос','Розуміє голосові та відповідає голосом — розпізнавання і синтез мовлення','Сам визначає етап угоди і веде по ньому — 7 етапів до закриття','Виявляє потребу за технікою SPIN, знімає заперечення, доводить до угоди','Повертається до «охололих» клієнтів сам — з тихими годинами (вночі не пише)','Памʼятає клієнта між діалогами: імʼя, бюджет, інтереси, історію','Відповідає за вашою базою знань — каталог, прайс, PDF, сайт','Передає гарячого ліда та задачі менеджеру, сповіщає на «гарячих» етапах','Записує ліда в CRM (HubSpot, Pipedrive), створює задачі і записує на зустріч','Розуміє російську, українську та англійську','Сам підбирає «потужність» ШІ під складність діалогу — економніше на простому'],
