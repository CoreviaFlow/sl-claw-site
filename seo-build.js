...
const UI = {
  ru:{ catalog:'Каталог ниш', pricing:'Тарифы', how:'Как это работает', cabinet:'Кабинет ↗',
       ...
       market:'Цифры рынка ниши', online:'в сети', getbot:'Подключить', askconsult:'Спросить у консультанта', blog:'Полезные материалы',
  ...
  uk:{ catalog:'Каталог ніш', pricing:'Тарифи', how:'Як це працює', cabinet:'Кабінет ↗',
       ...
       market:'Цифри ринку ніші', online:'у мережі', getbot:'Підключити', askconsult:'Запитати у консультанта', blog:'Корисні матеріали',
