...
<span class="c">$</span> docker compose up -d</div>
  ...
  <section class="partners-section" aria-labelledby="partners-h">
    ...
    <div class="partners-grid">
      ...
      <a class="partner-card" href="https://ringostat.com" target="_blank" rel="noopener noreferrer nofollow" aria-label="Ringostat">
        <div class="pc-logo" style="--brand:#0066ff;--brand-soft:#e6efff"><svg viewBox="0 0 24 24" aria-hidden="true"><rect x="2" y="2" width="20" height="20" rx="6" fill="currentColor"/><text x="12" y="17" text-anchor="middle" font-family="-apple-system,BlinkMacSystemFont,Segoe UI,Inter,system-ui,sans-serif" font-weight="800" font-size="14" fill="#fff" letter-spacing="-.5">R</text></svg></div>
        <b>Ringostat</b>
      </a>
      <a class="partner-card" href="https://www.bitrix24.com" target="_blank" rel="noopener noreferrer nofollow" aria-label="Bitrix24">
        <div class="pc-logo" style="--brand:#006DFF;--brand-soft:#e0edff"><svg viewBox="0 0 16 16" aria-hidden="true"><rect width="16" height="16" rx="5" fill="currentColor"/><path d="M7.815 11.237l-.003-1.076-3.464.008c.473-1.767 3.398-2.16 3.393-4.119-.003-1.05-.781-1.82-2.423-1.816-1.015.002-1.91.28-2.506.558l.36 1c.537-.25 1.163-.473 1.94-.474.597 0 1.165.247 1.167.881.004 1.435-3.43 1.553-3.719 5.058l5.255-.012zm.145-1.711l3.374-.008.005 1.71 1.343-.003-.005-1.71 1.135-.003-.003-1.05-1.135.003-.011-4.249-.985.002-3.72 4.479.001.83zm1.52-.997l1.904-2.378c0 .193-.058.8-.057 1.353l.003.993-.896.002c-.27 0-.776.029-.955.03z" fill="#fff"/></svg></div>
        <b>Bitrix24</b>
      </a>
      <a class="partner-card" href="https://salesdrive.ua" target="_blank" rel="noopener noreferrer nofollow" aria-label="SalesDrive">
        <div class="pc-logo" style="--brand:#1f7a3b;--brand-soft:#e6f3ec"><svg viewBox="0 0 24 24" aria-hidden="true"><rect x="2" y="2" width="20" height="20" rx="6" fill="currentColor"/><text x="12" y="17" text-anchor="middle" font-family="-apple-system,BlinkMacSystemFont,Segoe UI,Inter,system-ui,sans-serif" font-weight="800" font-size="14" fill="#fff" letter-spacing="-.5">S</text></svg></div>
        <b>SalesDrive</b>
      </a>
      <a class="partner-card" href="https://keycrm.app" target="_blank" rel="noopener noreferrer nofollow" aria-label="KeyCRM">
        <div class="pc-logo" style="--brand:#1976d2;--brand-soft:#e3f0fc"><svg viewBox="0 0 24 24" aria-hidden="true"><rect x="2" y="2" width="20" height="20" rx="6" fill="currentColor"/><text x="12" y="17" text-anchor="middle" font-family="-apple-system,BlinkMacSystemFont,Segoe UI,Inter,system-ui,sans-serif" font-weight="800" font-size="14" fill="#fff" letter-spacing="-.5">K</text></svg></div>
        <b>KeyCRM</b>
      </a>
    </div>
  </section>
