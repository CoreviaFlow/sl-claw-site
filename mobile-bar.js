/* Мобильная нижняя панель действий (только телефон, <=600px; CSS .mbar в styles.css).
   ...
   - статья блога   → Консультация + Подключить (checkout ниши статьи)
...
(function () {
  ...
  var L = uk
    ? { cons:'Консультація', buy:'Купити', get:'Підключити',   cat:'Каталог ніш', price:'Тарифи', pick:'Обрати нішу' }
    : { cons:'Консультация', buy:'Купить', get:'Подключить',   cat:'Каталог ниш', price:'Тарифы', pick:'Выбрать нишу' };
