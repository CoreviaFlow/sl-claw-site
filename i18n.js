...
(function () {
  ...
  var UI = {
    ...
    'pr.impl2': {ru:'Купили, но <b>не получилось развернуть самостоятельно</b> — или хотите доработать бота под себя? Рассмотрим <b>индивидуальное внедрение «под ключ»</b>: просто доплачиваете, и мы доводим бота до результата. Наша работа — <b>от $1600 + агент</b>. Напишите на <a href="mailto:support@sl-claw.tech" style="color:var(--accent-ink)">support@sl-claw.tech</a>.', uk:'Купили, але <b>не вийшло розгорнути самостійно</b> — чи хочете доопрацювати бота під себе? Розглянемо <b>індивідуальне впровадження «під ключ»</b>: просто доплачуєте, і ми доводимо бота до результату. Наша робота — <b>від $1600 + агент</b>. Напишіть на <a href="mailto:support@sl-claw.tech" style="color:var(--accent-ink)">support@sl-claw.tech</a>.'},
