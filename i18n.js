...
(function () {
  ...
  var UI = {
    ...
    'pr.closerlist': {ru:'<li>Выставляет счёт прямо в переписке — данные из вашей CRM или 1С</li><li>Скидывает драфт договора и коммерческое предложение под запрос клиента</li><li>Дожимает сделку: снимает последние возражения и подводит к оплате</li><li>Возвращается через время — проверяет статус сделки, переспрашивает по КП («рассмотрели предложение?») и аккуратно тревожит «дозревающего» клиента, пока тот не купит или не откажет</li>', uk:'<li>Виставляє рахунок прямо в листуванні — дані з вашої CRM або 1С</li><li>Скидає драфт договору та комерційну пропозицію під запит клієнта</li><li>Дотискає угоду: знімає останні заперечення й підводить до оплати</li><li>Повертається згодом — перевіряє статус угоди, перепитує по КП («розглянули пропозицію?») і акуратно турбує «дозріваючого» клієнта, поки той не купить або не відмовиться</li>'},
